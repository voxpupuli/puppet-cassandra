...
describe 'cassandra::private::opscenter::setting' do
  ...
  context 'agents agent_certfile' do
    ...
    it do
      should contain_ini_setting('agents agent_certfile').with('ensure' => 'absent',
                                                               'path'    => '/path/to/file',
                                                               'section' => 'agents',
                                                               'setting' => 'agent_certfile')
    end
  ...
  context 'agents agent_keyfile' do
    ...
    it do
      should contain_ini_setting('agents agent_keyfile').with('ensure' => 'absent',
                                                              'path'    => '/path/to/file',
                                                              'section' => 'agents',
                                                              'setting' => 'agent_keyfile')
    end
  ...
  context 'agents agent_keyfile_raw' do
    ...
    it do
      should contain_ini_setting('agents agent_keyfile_raw').with('ensure' => 'absent',
                                                                  'path'    => '/path/to/file',
                                                                  'section' => 'agents',
                                                                  'setting' => 'agent_keyfile_raw')
    end
  ...
  context 'agents config_sleep' do
    ...
    it do
      should contain_ini_setting('agents config_sleep').with('ensure' => 'absent',
                                                             'path'    => '/path/to/file',
                                                             'section' => 'agents',
                                                             'setting' => 'config_sleep')
    end
  ...
  context 'agents fingerprint_throttle' do
    ...
    it do
      should contain_ini_setting('agents fingerprint_throttle').with('ensure' => 'absent',
                                                                     'path'    => '/path/to/file',
                                                                     'section' => 'agents',
                                                                     'setting' => 'fingerprint_throttle')
    end
  ...
  context 'agents incoming_interface' do
    ...
    it do
      should contain_ini_setting('agents incoming_interface').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'agents',
                                                                   'setting' => 'incoming_interface')
    end
  ...
  context 'agents incoming_port' do
    ...
    it do
      should contain_ini_setting('agents incoming_port').with('ensure' => 'absent',
                                                              'path'    => '/path/to/file',
                                                              'section' => 'agents',
                                                              'setting' => 'incoming_port')
    end
  ...
  context 'agents install_throttle' do
    ...
    it do
      should contain_ini_setting('agents install_throttle').with('ensure' => 'absent',
                                                                 'path'    => '/path/to/file',
                                                                 'section' => 'agents',
                                                                 'setting' => 'install_throttle')
    end
  ...
  context 'agents not_seen_threshold' do
    ...
    it do
      should contain_ini_setting('agents not_seen_threshold').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'agents',
                                                                   'setting' => 'not_seen_threshold')
    end
  ...
  context 'agents path_to_deb' do
    ...
    it do
      should contain_ini_setting('agents path_to_deb').with('ensure' => 'absent',
                                                            'path'    => '/path/to/file',
                                                            'section' => 'agents',
                                                            'setting' => 'path_to_deb')
    end
  ...
  context 'agents path_to_find_java' do
    ...
    it do
      should contain_ini_setting('agents path_to_find_java').with('ensure' => 'absent',
                                                                  'path'    => '/path/to/file',
                                                                  'section' => 'agents',
                                                                  'setting' => 'path_to_find_java')
    end
  ...
  context 'agents path_to_installscript' do
    ...
    it do
      should contain_ini_setting('agents path_to_installscript').with('ensure' => 'absent',
                                                                      'path'    => '/path/to/file',
                                                                      'section' => 'agents',
                                                                      'setting' => 'path_to_installscript')
    end
  ...
  context 'agents path_to_rpm' do
    ...
    it do
      should contain_ini_setting('agents path_to_rpm').with('ensure' => 'absent',
                                                            'path'    => '/path/to/file',
                                                            'section' => 'agents',
                                                            'setting' => 'path_to_rpm')
    end
  ...
  context 'agents path_to_sudowrap' do
    ...
    it do
      should contain_ini_setting('agents path_to_sudowrap').with('ensure' => 'absent',
                                                                 'path'    => '/path/to/file',
                                                                 'section' => 'agents',
                                                                 'setting' => 'path_to_sudowrap')
    end
  ...
  context 'agents reported_interface' do
    ...
    it do
      should contain_ini_setting('agents reported_interface').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'agents',
                                                                   'setting' => 'reported_interface')
    end
  ...
  context 'agents runs_sudo' do
    ...
    it do
      should contain_ini_setting('agents runs_sudo').with('ensure' => 'absent',
                                                          'path'    => '/path/to/file',
                                                          'section' => 'agents',
                                                          'setting' => 'runs_sudo')
    end
  ...
  context 'agents scp_executable' do
    ...
    it do
      should contain_ini_setting('agents scp_executable').with('ensure' => 'absent',
                                                               'path'    => '/path/to/file',
                                                               'section' => 'agents',
                                                               'setting' => 'scp_executable')
    end
  ...
  context 'agents ssh_executable' do
    ...
    it do
      should contain_ini_setting('agents ssh_executable').with('ensure' => 'absent',
                                                               'path'    => '/path/to/file',
                                                               'section' => 'agents',
                                                               'setting' => 'ssh_executable')
    end
  ...
  context 'agents ssh_keygen_executable' do
    ...
    it do
      should contain_ini_setting('agents ssh_keygen_executable').with('ensure' => 'absent',
                                                                      'path'    => '/path/to/file',
                                                                      'section' => 'agents',
                                                                      'setting' => 'ssh_keygen_executable')
    end
  ...
  context 'agents ssh_keyscan_executable' do
    ...
    it do
      should contain_ini_setting('agents ssh_keyscan_executable').with('ensure' => 'absent',
                                                                       'path'    => '/path/to/file',
                                                                       'section' => 'agents',
                                                                       'setting' => 'ssh_keyscan_executable')
    end
  ...
  context 'agents ssh_port' do
    ...
    it do
      should contain_ini_setting('agents ssh_port').with('ensure' => 'absent',
                                                         'path'    => '/path/to/file',
                                                         'section' => 'agents',
                                                         'setting' => 'ssh_port')
    end
  ...
  context 'agents ssh_sys_known_hosts_file' do
    ...
    it do
      should contain_ini_setting('agents ssh_sys_known_hosts_file').with('ensure' => 'absent',
                                                                         'path'    => '/path/to/file',
                                                                         'section' => 'agents',
                                                                         'setting' => 'ssh_sys_known_hosts_file')
    end
  ...
  context 'agents ssh_user_known_hosts_file' do
    ...
    it do
      should contain_ini_setting('agents ssh_user_known_hosts_file').with('ensure' => 'absent',
                                                                          'path'    => '/path/to/file',
                                                                          'section' => 'agents',
                                                                          'setting' => 'ssh_user_known_hosts_file')
    end
  ...
  context 'agents ssl_certfile' do
    ...
    it do
      should contain_ini_setting('agents ssl_certfile').with('ensure' => 'absent',
                                                             'path'    => '/path/to/file',
                                                             'section' => 'agents',
                                                             'setting' => 'ssl_certfile')
    end
  ...
  context 'agents ssl_keyfile' do
    ...
    it do
      should contain_ini_setting('agents ssl_keyfile').with('ensure' => 'absent',
                                                            'path'    => '/path/to/file',
                                                            'section' => 'agents',
                                                            'setting' => 'ssl_keyfile')
    end
  ...
  context 'agents tmp_dir' do
    ...
    it do
      should contain_ini_setting('agents tmp_dir').with('ensure' => 'absent',
                                                        'path'    => '/path/to/file',
                                                        'section' => 'agents',
                                                        'setting' => 'tmp_dir')
    end
  ...
  context 'agents use_ssl' do
    ...
    it do
      should contain_ini_setting('agents use_ssl').with('ensure' => 'absent',
                                                        'path'    => '/path/to/file',
                                                        'section' => 'agents',
                                                        'setting' => 'use_ssl')
    end
  ...
  context 'authentication audit_auth' do
    ...
    it do
      should contain_ini_setting('authentication audit_auth').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'authentication',
                                                                   'setting' => 'audit_auth')
    end
  ...
  context 'authentication audit_pattern' do
    ...
    it do
      should contain_ini_setting('authentication audit_pattern').with('ensure' => 'absent',
                                                                      'path'    => '/path/to/file',
                                                                      'section' => 'authentication',
                                                                      'setting' => 'audit_pattern')
    end
  ...
  context 'authentication authentication_method' do
    ...
    it do
      should contain_ini_setting('authentication authentication_method').with('ensure' => 'absent',
                                                                              'path'    => '/path/to/file',
                                                                              'section' => 'authentication',
                                                                              'setting' => 'authentication_method')
    end
  ...
  context 'authentication enabled' do
    ...
    it do
      should contain_ini_setting('authentication enabled').with('ensure' => 'absent',
                                                                'path'    => '/path/to/file',
                                                                'section' => 'authentication',
                                                                'setting' => 'enabled')
    end
  ...
  context 'authentication passwd_db' do
    ...
    it do
      should contain_ini_setting('authentication passwd_db').with('ensure' => 'absent',
                                                                  'path'    => '/path/to/file',
                                                                  'section' => 'authentication',
                                                                  'setting' => 'passwd_db')
    end
  ...
  context 'authentication timeout' do
    ...
    it do
      should contain_ini_setting('authentication timeout').with('ensure' => 'absent',
                                                                'path'    => '/path/to/file',
                                                                'section' => 'authentication',
                                                                'setting' => 'timeout')
    end
  ...
  context 'cloud accepted_certs' do
    ...
    it do
      should contain_ini_setting('cloud accepted_certs').with('ensure' => 'absent',
                                                              'path'    => '/path/to/file',
                                                              'section' => 'cloud',
                                                              'setting' => 'accepted_certs')
    end
  ...
  context 'clusters add_cluster_timeout' do
    ...
    it do
      should contain_ini_setting('clusters add_cluster_timeout').with('ensure' => 'absent',
                                                                      'path'    => '/path/to/file',
                                                                      'section' => 'clusters',
                                                                      'setting' => 'add_cluster_timeout')
    end
  ...
  context 'clusters startup_sleep' do
    ...
    it do
      should contain_ini_setting('clusters startup_sleep').with('ensure' => 'absent',
                                                                'path'    => '/path/to/file',
                                                                'section' => 'clusters',
                                                                'setting' => 'startup_sleep')
    end
  ...
  context 'definitions auto_update' do
    ...
    it do
      should contain_ini_setting('definitions auto_update').with('ensure' => 'absent',
                                                                 'path'    => '/path/to/file',
                                                                 'section' => 'definitions',
                                                                 'setting' => 'auto_update')
    end
  ...
  context 'definitions definitions_dir' do
    ...
    it do
      should contain_ini_setting('definitions definitions_dir').with('ensure' => 'absent',
                                                                     'path'    => '/path/to/file',
                                                                     'section' => 'definitions',
                                                                     'setting' => 'definitions_dir')
    end
  ...
  context 'definitions download_filename' do
    ...
    it do
      should contain_ini_setting('definitions download_filename').with('ensure' => 'absent',
                                                                       'path'    => '/path/to/file',
                                                                       'section' => 'definitions',
                                                                       'setting' => 'download_filename')
    end
  ...
  context 'definitions download_host' do
    ...
    it do
      should contain_ini_setting('definitions download_host').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'definitions',
                                                                   'setting' => 'download_host')
    end
  ...
  context 'definitions download_port' do
    ...
    it do
      should contain_ini_setting('definitions download_port').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'definitions',
                                                                   'setting' => 'download_port')
    end
  ...
  context 'definitions hash_filename' do
    ...
    it do
      should contain_ini_setting('definitions hash_filename').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'definitions',
                                                                   'setting' => 'hash_filename')
    end
  ...
  context 'definitions sleep' do
    ...
    it do
      should contain_ini_setting('definitions sleep').with('ensure' => 'absent',
                                                           'path'    => '/path/to/file',
                                                           'section' => 'definitions',
                                                           'setting' => 'sleep')
    end
  ...
  context 'definitions ssl_certfile' do
    ...
    it do
      should contain_ini_setting('definitions ssl_certfile').with('ensure' => 'absent',
                                                                  'path'    => '/path/to/file',
                                                                  'section' => 'definitions',
                                                                  'setting' => 'ssl_certfile')
    end
  ...
  context 'definitions use_ssl' do
    ...
    it do
      should contain_ini_setting('definitions use_ssl').with('ensure' => 'absent',
                                                             'path'    => '/path/to/file',
                                                             'section' => 'definitions',
                                                             'setting' => 'use_ssl')
    end
  ...
  context 'failover failover_configuration_directory' do
    ...
    it do
      should contain_ini_setting('failover failover_configuration_directory').with('ensure' => 'absent',
                                                                                   'path'    => '/path/to/file',
                                                                                   'section' => 'failover',
                                                                                   'setting' => 'failover_configuration_directory')
    end
  ...
  context 'failover heartbeat_fail_window' do
    ...
    it do
      should contain_ini_setting('failover heartbeat_fail_window').with('ensure' => 'absent',
                                                                        'path'    => '/path/to/file',
                                                                        'section' => 'failover',
                                                                        'setting' => 'heartbeat_fail_window')
    end
  ...
  context 'failover heartbeat_period' do
    ...
    it do
      should contain_ini_setting('failover heartbeat_period').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'failover',
                                                                   'setting' => 'heartbeat_period')
    end
  ...
  context 'failover heartbeat_reply_period' do
    ...
    it do
      should contain_ini_setting('failover heartbeat_reply_period').with('ensure' => 'absent',
                                                                         'path'    => '/path/to/file',
                                                                         'section' => 'failover',
                                                                         'setting' => 'heartbeat_reply_period')
    end
  ...
  context 'hadoop base_job_tracker_proxy_port' do
    ...
    it do
      should contain_ini_setting('hadoop base_job_tracker_proxy_port').with('ensure' => 'absent',
                                                                            'path'    => '/path/to/file',
                                                                            'section' => 'hadoop',
                                                                            'setting' => 'base_job_tracker_proxy_port')
    end
  ...
  context 'labs orbited_longpoll' do
    ...
    it do
      should contain_ini_setting('labs orbited_longpoll').with('ensure' => 'absent',
                                                               'path'    => '/path/to/file',
                                                               'section' => 'labs',
                                                               'setting' => 'orbited_longpoll')
    end
  ...
  context 'ldap admin_group_name' do
    ...
    it do
      should contain_ini_setting('ldap admin_group_name').with('ensure' => 'absent',
                                                               'path'    => '/path/to/file',
                                                               'section' => 'ldap',
                                                               'setting' => 'admin_group_name')
    end
  ...
  context 'ldap connection_timeout' do
    ...
    it do
      should contain_ini_setting('ldap connection_timeout').with('ensure' => 'absent',
                                                                 'path'    => '/path/to/file',
                                                                 'section' => 'ldap',
                                                                 'setting' => 'connection_timeout')
    end
  ...
  context 'ldap debug_ssl' do
    ...
    it do
      should contain_ini_setting('ldap debug_ssl').with('ensure' => 'absent',
                                                        'path'    => '/path/to/file',
                                                        'section' => 'ldap',
                                                        'setting' => 'debug_ssl')
    end
  ...
  context 'ldap group_name_attribute' do
    ...
    it do
      should contain_ini_setting('ldap group_name_attribute').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'ldap',
                                                                   'setting' => 'group_name_attribute')
    end
  ...
  context 'ldap group_search_base' do
    ...
    it do
      should contain_ini_setting('ldap group_search_base').with('ensure' => 'absent',
                                                                'path'    => '/path/to/file',
                                                                'section' => 'ldap',
                                                                'setting' => 'group_search_base')
    end
  ...
  context 'ldap group_search_filter' do
    ...
    it do
      should contain_ini_setting('ldap group_search_filter').with('ensure' => 'absent',
                                                                  'path'    => '/path/to/file',
                                                                  'section' => 'ldap',
                                                                  'setting' => 'group_search_filter')
    end
  ...
  context 'ldap group_search_type' do
    ...
    it do
      should contain_ini_setting('ldap group_search_type').with('ensure' => 'absent',
                                                                'path'    => '/path/to/file',
                                                                'section' => 'ldap',
                                                                'setting' => 'group_search_type')
    end
  ...
  context 'ldap ldap_security' do
    ...
    it do
      should contain_ini_setting('ldap ldap_security').with('ensure' => 'absent',
                                                            'path'    => '/path/to/file',
                                                            'section' => 'ldap',
                                                            'setting' => 'ldap_security')
    end
  ...
  context 'ldap opt_referrals' do
    ...
    it do
      should contain_ini_setting('ldap opt_referrals').with('ensure' => 'absent',
                                                            'path'    => '/path/to/file',
                                                            'section' => 'ldap',
                                                            'setting' => 'opt_referrals')
    end
  ...
  context 'ldap protocol_version' do
    ...
    it do
      should contain_ini_setting('ldap protocol_version').with('ensure' => 'absent',
                                                               'path'    => '/path/to/file',
                                                               'section' => 'ldap',
                                                               'setting' => 'protocol_version')
    end
  ...
  context 'ldap search_dn' do
    ...
    it do
      should contain_ini_setting('ldap search_dn').with('ensure' => 'absent',
                                                        'path'    => '/path/to/file',
                                                        'section' => 'ldap',
                                                        'setting' => 'search_dn')
    end
  ...
  context 'ldap search_password' do
    ...
    it do
      should contain_ini_setting('ldap search_password').with('ensure' => 'absent',
                                                              'path'    => '/path/to/file',
                                                              'section' => 'ldap',
                                                              'setting' => 'search_password')
    end
  ...
  context 'ldap server_host' do
    ...
    it do
      should contain_ini_setting('ldap server_host').with('ensure' => 'absent',
                                                          'path'    => '/path/to/file',
                                                          'section' => 'ldap',
                                                          'setting' => 'server_host')
    end
  ...
  context 'ldap server_port' do
    ...
    it do
      should contain_ini_setting('ldap server_port').with('ensure' => 'absent',
                                                          'path'    => '/path/to/file',
                                                          'section' => 'ldap',
                                                          'setting' => 'server_port')
    end
  ...
  context 'ldap ssl_cacert' do
    ...
    it do
      should contain_ini_setting('ldap ssl_cacert').with('ensure' => 'absent',
                                                         'path'    => '/path/to/file',
                                                         'section' => 'ldap',
                                                         'setting' => 'ssl_cacert')
    end
  ...
  context 'ldap ssl_cert' do
    ...
    it do
      should contain_ini_setting('ldap ssl_cert').with('ensure' => 'absent',
                                                       'path'    => '/path/to/file',
                                                       'section' => 'ldap',
                                                       'setting' => 'ssl_cert')
    end
  ...
  context 'ldap ssl_key' do
    ...
    it do
      should contain_ini_setting('ldap ssl_key').with('ensure' => 'absent',
                                                      'path'    => '/path/to/file',
                                                      'section' => 'ldap',
                                                      'setting' => 'ssl_key')
    end
  ...
  context 'ldap tls_demand' do
    ...
    it do
      should contain_ini_setting('ldap tls_demand').with('ensure' => 'absent',
                                                         'path'    => '/path/to/file',
                                                         'section' => 'ldap',
                                                         'setting' => 'tls_demand')
    end
  ...
  context 'ldap tls_reqcert' do
    ...
    it do
      should contain_ini_setting('ldap tls_reqcert').with('ensure' => 'absent',
                                                          'path'    => '/path/to/file',
                                                          'section' => 'ldap',
                                                          'setting' => 'tls_reqcert')
    end
  ...
  context 'ldap uri_scheme' do
    ...
    it do
      should contain_ini_setting('ldap uri_scheme').with('ensure' => 'absent',
                                                         'path'    => '/path/to/file',
                                                         'section' => 'ldap',
                                                         'setting' => 'uri_scheme')
    end
  ...
  context 'ldap user_memberof_attribute' do
    ...
    it do
      should contain_ini_setting('ldap user_memberof_attribute').with('ensure' => 'absent',
                                                                      'path'    => '/path/to/file',
                                                                      'section' => 'ldap',
                                                                      'setting' => 'user_memberof_attribute')
    end
  ...
  context 'ldap user_search_base' do
    ...
    it do
      should contain_ini_setting('ldap user_search_base').with('ensure' => 'absent',
                                                               'path'    => '/path/to/file',
                                                               'section' => 'ldap',
                                                               'setting' => 'user_search_base')
    end
  ...
  context 'ldap user_search_filter' do
    ...
    it do
      should contain_ini_setting('ldap user_search_filter').with('ensure' => 'absent',
                                                                 'path'    => '/path/to/file',
                                                                 'section' => 'ldap',
                                                                 'setting' => 'user_search_filter')
    end
  ...
  context 'logging level' do
    ...
    it do
      should contain_ini_setting('logging level').with('ensure' => 'absent',
                                                       'path'    => '/path/to/file',
                                                       'section' => 'logging',
                                                       'setting' => 'level')
    end
  ...
  context 'logging log_length' do
    ...
    it do
      should contain_ini_setting('logging log_length').with('ensure' => 'absent',
                                                            'path'    => '/path/to/file',
                                                            'section' => 'logging',
                                                            'setting' => 'log_length')
    end
  ...
  context 'logging log_path' do
    ...
    it do
      should contain_ini_setting('logging log_path').with('ensure' => 'absent',
                                                          'path'    => '/path/to/file',
                                                          'section' => 'logging',
                                                          'setting' => 'log_path')
    end
  ...
  context 'logging max_rotate' do
    ...
    it do
      should contain_ini_setting('logging max_rotate').with('ensure' => 'absent',
                                                            'path'    => '/path/to/file',
                                                            'section' => 'logging',
                                                            'setting' => 'max_rotate')
    end
  ...
  context 'logging resource_usage_interval' do
    ...
    it do
      should contain_ini_setting('logging resource_usage_interval').with('ensure' => 'absent',
                                                                         'path'    => '/path/to/file',
                                                                         'section' => 'logging',
                                                                         'setting' => 'resource_usage_interval')
    end
  ...
  context 'provisioning agent_install_timeout' do
    ...
    it do
      should contain_ini_setting('provisioning agent_install_timeout').with('ensure' => 'absent',
                                                                            'path'    => '/path/to/file',
                                                                            'section' => 'provisioning',
                                                                            'setting' => 'agent_install_timeout')
    end
  ...
  context 'provisioning keyspace_timeout' do
    ...
    it do
      should contain_ini_setting('provisioning keyspace_timeout').with('ensure' => 'absent',
                                                                       'path'    => '/path/to/file',
                                                                       'section' => 'provisioning',
                                                                       'setting' => 'keyspace_timeout')
    end
  ...
  context 'provisioning private_key_dir' do
    ...
    it do
      should contain_ini_setting('provisioning private_key_dir').with('ensure' => 'absent',
                                                                      'path'    => '/path/to/file',
                                                                      'section' => 'provisioning',
                                                                      'setting' => 'private_key_dir')
    end
  ...
  context 'repair_service alert_on_repair_failure' do
    ...
    it do
      should contain_ini_setting('repair_service alert_on_repair_failure').with('ensure' => 'absent',
                                                                                'path'    => '/path/to/file',
                                                                                'section' => 'repair_service',
                                                                                'setting' => 'alert_on_repair_failure')
    end
  ...
  context 'repair_service cluster_stabilization_period' do
    ...
    it do
      should contain_ini_setting('repair_service cluster_stabilization_period').with('ensure' => 'absent',
                                                                                     'path'    => '/path/to/file',
                                                                                     'section' => 'repair_service',
                                                                                     'setting' => 'cluster_stabilization_period')
    end
  ...
  context 'repair_service error_logging_window' do
    ...
    it do
      should contain_ini_setting('repair_service error_logging_window').with('ensure' => 'absent',
                                                                             'path'    => '/path/to/file',
                                                                             'section' => 'repair_service',
                                                                             'setting' => 'error_logging_window')
    end
  ...
  context 'repair_service incremental_err_alert_threshold' do
    ...
    it do
      should contain_ini_setting('repair_service incremental_err_alert_threshold').with('ensure' => 'absent',
                                                                                        'path'    => '/path/to/file',
                                                                                        'section' => 'repair_service',
                                                                                        'setting' => 'incremental_err_alert_threshold')
    end
  ...
  context 'repair_service incremental_range_repair' do
    ...
    it do
      should contain_ini_setting('repair_service incremental_range_repair').with('ensure' => 'absent',
                                                                                 'path'    => '/path/to/file',
                                                                                 'section' => 'repair_service',
                                                                                 'setting' => 'incremental_range_repair')
    end
  ...
  context 'repair_service incremental_repair_tables' do
    ...
    it do
      should contain_ini_setting('repair_service incremental_repair_tables').with('ensure' => 'absent',
                                                                                  'path'    => '/path/to/file',
                                                                                  'section' => 'repair_service',
                                                                                  'setting' => 'incremental_repair_tables')
    end
  ...
  context 'repair_service ks_update_period' do
    ...
    it do
      should contain_ini_setting('repair_service ks_update_period').with('ensure' => 'absent',
                                                                         'path'    => '/path/to/file',
                                                                         'section' => 'repair_service',
                                                                         'setting' => 'ks_update_period')
    end
  ...
  context 'repair_service log_directory' do
    ...
    it do
      should contain_ini_setting('repair_service log_directory').with('ensure' => 'absent',
                                                                      'path'    => '/path/to/file',
                                                                      'section' => 'repair_service',
                                                                      'setting' => 'log_directory')
    end
  ...
  context 'repair_service log_length' do
    ...
    it do
      should contain_ini_setting('repair_service log_length').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'repair_service',
                                                                   'setting' => 'log_length')
    end
  ...
  context 'repair_service max_err_threshold' do
    ...
    it do
      should contain_ini_setting('repair_service max_err_threshold').with('ensure' => 'absent',
                                                                          'path'    => '/path/to/file',
                                                                          'section' => 'repair_service',
                                                                          'setting' => 'max_err_threshold')
    end
  ...
  context 'repair_service max_parallel_repairs' do
    ...
    it do
      should contain_ini_setting('repair_service max_parallel_repairs').with('ensure' => 'absent',
                                                                             'path'    => '/path/to/file',
                                                                             'section' => 'repair_service',
                                                                             'setting' => 'max_parallel_repairs')
    end
  ...
  context 'repair_service max_pending_repairs' do
    ...
    it do
      should contain_ini_setting('repair_service max_pending_repairs').with('ensure' => 'absent',
                                                                            'path'    => '/path/to/file',
                                                                            'section' => 'repair_service',
                                                                            'setting' => 'max_pending_repairs')
    end
  ...
  context 'repair_service max_rotate' do
    ...
    it do
      should contain_ini_setting('repair_service max_rotate').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'repair_service',
                                                                   'setting' => 'max_rotate')
    end
  ...
  context 'repair_service min_repair_time' do
    ...
    it do
      should contain_ini_setting('repair_service min_repair_time').with('ensure' => 'absent',
                                                                        'path'    => '/path/to/file',
                                                                        'section' => 'repair_service',
                                                                        'setting' => 'min_repair_time')
    end
  ...
  context 'repair_service min_throughput' do
    ...
    it do
      should contain_ini_setting('repair_service min_throughput').with('ensure' => 'absent',
                                                                       'path'    => '/path/to/file',
                                                                       'section' => 'repair_service',
                                                                       'setting' => 'min_throughput')
    end
  ...
  context 'repair_service num_recent_throughputs' do
    ...
    it do
      should contain_ini_setting('repair_service num_recent_throughputs').with('ensure' => 'absent',
                                                                               'path'    => '/path/to/file',
                                                                               'section' => 'repair_service',
                                                                               'setting' => 'num_recent_throughputs')
    end
  ...
  context 'repair_service persist_directory' do
    ...
    it do
      should contain_ini_setting('repair_service persist_directory').with('ensure' => 'absent',
                                                                          'path'    => '/path/to/file',
                                                                          'section' => 'repair_service',
                                                                          'setting' => 'persist_directory')
    end
  ...
  context 'repair_service persist_period' do
    ...
    it do
      should contain_ini_setting('repair_service persist_period').with('ensure' => 'absent',
                                                                       'path'    => '/path/to/file',
                                                                       'section' => 'repair_service',
                                                                       'setting' => 'persist_period')
    end
  ...
  context 'repair_service restart_period' do
    ...
    it do
      should contain_ini_setting('repair_service restart_period').with('ensure' => 'absent',
                                                                       'path'    => '/path/to/file',
                                                                       'section' => 'repair_service',
                                                                       'setting' => 'restart_period')
    end
  ...
  context 'repair_service single_repair_timeout' do
    ...
    it do
      should contain_ini_setting('repair_service single_repair_timeout').with('ensure' => 'absent',
                                                                              'path'    => '/path/to/file',
                                                                              'section' => 'repair_service',
                                                                              'setting' => 'single_repair_timeout')
    end
  ...
  context 'repair_service single_task_err_threshold' do
    ...
    it do
      should contain_ini_setting('repair_service single_task_err_threshold').with('ensure' => 'absent',
                                                                                  'path'    => '/path/to/file',
                                                                                  'section' => 'repair_service',
                                                                                  'setting' => 'single_task_err_threshold')
    end
  ...
  context 'repair_service snapshot_override' do
    ...
    it do
      should contain_ini_setting('repair_service snapshot_override').with('ensure' => 'absent',
                                                                          'path'    => '/path/to/file',
                                                                          'section' => 'repair_service',
                                                                          'setting' => 'snapshot_override')
    end
  ...
  context 'request_tracker queue_size' do
    ...
    it do
      should contain_ini_setting('request_tracker queue_size').with('ensure' => 'absent',
                                                                    'path'    => '/path/to/file',
                                                                    'section' => 'request_tracker',
                                                                    'setting' => 'queue_size')
    end
  ...
  context 'security config_encryption_active' do
    ...
    it do
      should contain_ini_setting('security config_encryption_active').with('ensure' => 'absent',
                                                                           'path'    => '/path/to/file',
                                                                           'section' => 'security',
                                                                           'setting' => 'config_encryption_active')
    end
  ...
  context 'security config_encryption_key_name' do
    ...
    it do
      should contain_ini_setting('security config_encryption_key_name').with('ensure' => 'absent',
                                                                             'path'    => '/path/to/file',
                                                                             'section' => 'security',
                                                                             'setting' => 'config_encryption_key_name')
    end
  ...
  context 'security config_encryption_key_path' do
    ...
    it do
      should contain_ini_setting('security config_encryption_key_path').with('ensure' => 'absent',
                                                                             'path'    => '/path/to/file',
                                                                             'section' => 'security',
                                                                             'setting' => 'config_encryption_key_path')
    end
  ...
  context 'spark base_master_proxy_port' do
    ...
    it do
      should contain_ini_setting('spark base_master_proxy_port').with('ensure' => 'absent',
                                                                      'path'    => '/path/to/file',
                                                                      'section' => 'spark',
                                                                      'setting' => 'base_master_proxy_port')
    end
  ...
  context 'stat_reporter initial_sleep' do
    ...
    it do
      should contain_ini_setting('stat_reporter initial_sleep').with('ensure' => 'absent',
                                                                     'path'    => '/path/to/file',
                                                                     'section' => 'stat_reporter',
                                                                     'setting' => 'initial_sleep')
    end
  ...
  context 'stat_reporter interval' do
    ...
    it do
      should contain_ini_setting('stat_reporter interval').with('ensure' => 'absent',
                                                                'path'    => '/path/to/file',
                                                                'section' => 'stat_reporter',
                                                                'setting' => 'interval')
    end
  ...
  context 'stat_reporter report_file' do
    ...
    it do
      should contain_ini_setting('stat_reporter report_file').with('ensure' => 'absent',
                                                                   'path'    => '/path/to/file',
                                                                   'section' => 'stat_reporter',
                                                                   'setting' => 'report_file')
    end
  ...
  context 'stat_reporter ssl_key' do
    ...
    it do
      should contain_ini_setting('stat_reporter ssl_key').with('ensure' => 'absent',
                                                               'path'    => '/path/to/file',
                                                               'section' => 'stat_reporter',
                                                               'setting' => 'ssl_key')
    end
  ...
  context 'ui default_api_timeout' do
    ...
    it do
      should contain_ini_setting('ui default_api_timeout').with('ensure' => 'absent',
                                                                'path'    => '/path/to/file',
                                                                'section' => 'ui',
                                                                'setting' => 'default_api_timeout')
    end
  ...
  context 'ui max_metrics_requests' do
    ...
    it do
      should contain_ini_setting('ui max_metrics_requests').with('ensure' => 'absent',
                                                                 'path'    => '/path/to/file',
                                                                 'section' => 'ui',
                                                                 'setting' => 'max_metrics_requests')
    end
  ...
  context 'ui node_detail_refresh_delay' do
    ...
    it do
      should contain_ini_setting('ui node_detail_refresh_delay').with('ensure' => 'absent',
                                                                      'path'    => '/path/to/file',
                                                                      'section' => 'ui',
                                                                      'setting' => 'node_detail_refresh_delay')
    end
  ...
  context 'ui storagemap_ttl' do
    ...
    it do
      should contain_ini_setting('ui storagemap_ttl').with('ensure' => 'absent',
                                                           'path'    => '/path/to/file',
                                                           'section' => 'ui',
                                                           'setting' => 'storagemap_ttl')
    end
  ...
  context 'webserver interface' do
    ...
    it do
      should contain_ini_setting('webserver interface').with('ensure' => 'absent',
                                                             'path'    => '/path/to/file',
                                                             'section' => 'webserver',
                                                             'setting' => 'interface')
    end
  ...
  context 'webserver log_path' do
    ...
    it do
      should contain_ini_setting('webserver log_path').with('ensure' => 'absent',
                                                            'path'    => '/path/to/file',
                                                            'section' => 'webserver',
                                                            'setting' => 'log_path')
    end
  ...
  context 'webserver port' do
    ...
    it do
      should contain_ini_setting('webserver port').with('ensure' => 'absent',
                                                        'path'    => '/path/to/file',
                                                        'section' => 'webserver',
                                                        'setting' => 'port')
    end
  ...
  context 'webserver ssl_certfile' do
    ...
    it do
      should contain_ini_setting('webserver ssl_certfile').with('ensure' => 'absent',
                                                                'path'    => '/path/to/file',
                                                                'section' => 'webserver',
                                                                'setting' => 'ssl_certfile')
    end
  ...
  context 'webserver ssl_keyfile' do
    ...
    it do
      should contain_ini_setting('webserver ssl_keyfile').with('ensure' => 'absent',
                                                               'path'    => '/path/to/file',
                                                               'section' => 'webserver',
                                                               'setting' => 'ssl_keyfile')
    end
  ...
  context 'webserver ssl_port' do
    ...
    it do
      should contain_ini_setting('webserver ssl_port').with('ensure' => 'absent',
                                                            'path'    => '/path/to/file',
                                                            'section' => 'webserver',
                                                            'setting' => 'ssl_port')
    end
  ...
  context 'webserver staticdir' do
    ...
    it do
      should contain_ini_setting('webserver staticdir').with('ensure' => 'absent',
                                                             'path'    => '/path/to/file',
                                                             'section' => 'webserver',
                                                             'setting' => 'staticdir')
    end
  ...
  context 'webserver sub_process_timeout' do
    ...
    it do
      should contain_ini_setting('webserver sub_process_timeout').with('ensure' => 'absent',
                                                                       'path'    => '/path/to/file',
                                                                       'section' => 'webserver',
                                                                       'setting' => 'sub_process_timeout')
    end
  ...
  context 'webserver tarball_process_timeout' do
    ...
    it do
      should contain_ini_setting('webserver tarball_process_timeout').with('ensure' => 'absent',
                                                                           'path'    => '/path/to/file',
                                                                           'section' => 'webserver',
                                                                           'setting' => 'tarball_process_timeout')
    end
