...
if ($facts['memory.system.available_bytes'] / 1024 / 1024) < 24576.0 {
  $max_heap_size_in_mb = floor($facts['memory.system.available_bytes'] / 1024 / 1024 / 2)
} elsif ($facts['memory.system.available_bytes'] / 1024 / 1024) < 8192.0 {
  $max_heap_size_in_mb = floor($facts['memory.system.available_bytes'] / 1024 / 1024 / 4)
} else {
